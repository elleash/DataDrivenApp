...
# function to get pokemon information
def get_url(func):
...
def get_random_pokemon():
    rand_poke = random.randint(1,1015) # randomizes a number from 1 to 1015 and store in a variable
...
swirl1 = Image.open("swirls.png")
resized_swirl = swirl1.resize((800,100))
...
# created entry for user to enter the pokemon's name
entry = Entry(main_frame, font = ('Veradna'))
...
stat_button = Button(display_frame, text = 'Get Stats!', font = ('Verdana', 10), bg = '#ECC957', fg = '#391B00',
